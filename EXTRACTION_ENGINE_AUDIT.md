...
**Generated:** 2026-06-13T09:07:02.353Z  
...
| Suite | Result | Notes |
|-------|--------|-------|
| `qa:multi-format-extraction` | **PASS** | pass≈0 fail≈0 |
| `qa:document-extract` | **PASS** | pass≈0 fail≈0 |
| `qa:no-fake-data-policy` | **PASS** | pass≈26 fail≈0 |
| `qa:extraction-confidence-tiers` | **PASS** | pass≈19 fail≈0 |
| `qa:extraction-lock` | **PASS** | pass≈0 fail≈0 |
| `qa:extraction-loss-audit` | **FAIL** | pass≈1 fail≈13 |
| `qa:semantic-confidence-gate` | **FAIL** | pass≈0 fail≈0 |
| `qa:name-phone-rewrite` | **PASS** | pass≈27 fail≈0 |
| `qa:person-company-disambiguation` | **PASS** | pass≈30 fail≈0 |
